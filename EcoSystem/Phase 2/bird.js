function Bird(loc, ctxArray, worldWidth, worldHeight){
...
Bird.prototype.checkEdges = function(){
  if (this.loc.x >= world.dimensions.x/2){
    this.loc.x = 0;
  }
  else if(this.loc.x <= -world.dimensions.x/2){
    this.loc.x = world.dimensions.x;
  }
  if (this.loc.y >= world.dimensions.y/2){
    this.loc.y = 0;
  }
  else if(this.loc.y < -world.dimensions.y/2){
    this.loc.y = world.dimensions.y;
  }
  }
